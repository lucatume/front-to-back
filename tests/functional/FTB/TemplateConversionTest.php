...
TEMPLATE;
	 ...
	 */
	public function it_should_replace_the_ftb_title_tag_with_wp_title_template_tag( $in_tag, $out_tag ) {
		$sut = $this->make_instance();
...
TEMPLATE;
		...
		$this->assertTrue( html_strcasecmp( $expected_template_contents, $out ) );
	}
